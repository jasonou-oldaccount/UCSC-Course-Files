...
* File name: CalcTest.java
* Description: Unit tests for Calc.java
*/
...
public class CalcTest {
	...
	public void depthAndPeekTest() {
		...
		c.push(10.0);
		c.add();
		assertEquals(15.0, c.peek(), EPSILON);
		c.push(10.0);
		c.multiply();
		assertEquals(1, c.depth(), EPSILON);
	}
	
	// Testing for reciprocal failure
	@Test (expected=RuntimeException.class)
	public void reciprocalFailTest() {
		Calc c = new Calc();
		c.reciprocal();
	}
